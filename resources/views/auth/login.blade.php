...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-b from-yellow-300 to-yellow-400">
    <div class="max-w-md w-full p-6 bg-white rounded shadow">
        ...
        <h1 class="text-3xl font-bold mb-4 text-center text-orange-500">Chào Ba, Mẹ</h1>
        <p class="text-center text-gray-600 mb-6">Chúng ta sẽ đăng nhập ở đây.</p>
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('login') }}">
            @csrf
            <input type="text" name="phone" placeholder="Số điện thoại" class="w-full border border-gray-300 rounded py-2 px-4 mb-4 focus:outline-none focus:ring-2 focus:ring-orange-400" />
