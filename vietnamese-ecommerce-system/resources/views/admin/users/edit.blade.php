...
@section('content')
<h1 class="text-2xl font-semibold mb-4">Chỉnh sửa người dùng</h1>
...
<form action="{{ route('admin.users.update', $user) }}" method="POST" class="max-w-lg">
    ...
    <div class="mb-4">
        <label for="password" class="block font-medium mb-1">Mật khẩu (để trống nếu không đổi)</label>
    ...
    <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Cập nhật người dùng</button>
</form>
@endsection
